...
def _add_commit_signature() -> str:
    return (
        ...
        "It will always be suffixed with a line telling it was generated by Gonka AI with the appropriate co-authoring information.\n"
        "The format you will always uses is the following heredoc.\n\n"
        "```bash\n"
        "git commit -m <Commit message here>\n\n"
        "Generated by Gonka AI.\n"
        "Co-Authored-By: Gonka AI <vibe@gonka.ai>\n"
        "```"
    )
